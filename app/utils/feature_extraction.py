...
def parallel_process_rows(X, feature_scale, model_id, augmented_records, desc, max_workers=4):
...
def build_augmented_feature_dfs(feature_scale, columns, noise_label, augmented_records, max_workers=4):
    all_results = []
